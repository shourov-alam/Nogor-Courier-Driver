...
public class Post_Read extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post__read);
    ...
    public void loadData() {
        ...
        Query fireBaseQusery  = ref.orderByChild("driver_checked").equalTo(FirebaseAuth.getInstance().getUid()) ;
